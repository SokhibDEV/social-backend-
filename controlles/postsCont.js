...
export const getPosts = (req, res) => {
  ...
  jwt.verify(token, "secretKey", (err, userInfo) => {
    ...
    const q = (userId !=="undefined" )? `SELECT  p.desc, p.postId, p.createdAt, p.img, u.userId, name, profilePic FROM posts AS p join users as u on(u.userId = p.userId) WHERE p.userId = ? ORDER BY p.createdAt DESC` 
